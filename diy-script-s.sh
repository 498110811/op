...
sed -i '/set wireless.default_radio${devidx}.encryption=psk2+ccmp/a\\t\t\tset wireless.default_radio${devidx}.key=wsh.498110811' package/kernel/mac80211/files/lib/wifi/mac80211.sh
